      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          <View style={[styles.imageCard, { backgroundColor: isDarkMode ? '#2a2a4a' : '#ffffff' }]}>
            ...
            {(analysis as any).dominantColor ? (
              <>
                <Text style={[styles.dominantColorName, { color: isDarkMode ? '#1f2937' : '#1f2937' }]}>{(analysis as any).dominantColor.name}</Text>
                <Text style={[styles.dominantColorConfidence, { color: isDarkMode ? '#6b7280' : '#6b7280' }]}>Dominant Color ({(analysis as any).dominantColor.confidence}% confidence)</Text>
              </>
            ) : (
              <>
